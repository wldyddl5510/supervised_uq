...
class DownConvBlock(nn.Module):
    ...
    """
    def __init__(self, input_dim, output_dim, initializers, padding, pool=True, vb=True):
        ...
        if not vb:
            ...
            # convolution with variational dropout
            layers.append(GaussianConv2d(output_dim, output_dim, kernel_size=3, stride=1, padding=int(padding), deterministic=False))
...
class UpConvBlock(nn.Module):
    ...
    """
    def __init__(self, input_dim, output_dim, initializers, padding, bilinear=True, vb=True):
        ...
        self.conv_block = DownConvBlock(input_dim, output_dim, initializers, padding, pool=False, vb=vb)
